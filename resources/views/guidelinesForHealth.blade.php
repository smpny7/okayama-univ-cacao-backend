...
@section('content')
    <div class="mt-3 md:mt-12 px-4 py-4 md:py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div class="max-w-3xl sm:mx-auto">
            ...
            <p>
                本アプリ要求する情報はあなたのデバイスに保持され、収集することはありません。
                また、本アプリは医学的決定を下さず、医学的な情報を提供しません。
                そのため、このアプリを通じて自身の健康に疑問がある場合は、医師の診断を受けて、その指示に従ってください。
            </p>
            <p class="mt-4">（このガイドラインは、2021年7月22日に制定されました）</p>
        </div>
    </div>
@endsection
